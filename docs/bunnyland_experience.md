...
This is the design vision, not a completion tracker. The canonical implementation status is
[`bunnyland_experience_checklist.md`](bunnyland_experience_checklist.md), and release gates
...
The bullets below describe intended capabilities and deliberately carry no independent
checkbox state.
...
- Build a **valid-actions projection**: character views serialize registry-derived
...
- Build **valid-targets** resolution per action: `target_groups` contains the reachable
...
- **Progressive disclosure of detail**: component-owned facts carry numeric detail
