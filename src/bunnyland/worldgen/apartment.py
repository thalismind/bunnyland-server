...
def _routines(actor, character_id, schedule):
    ...
    for hour, activity in schedule:
        routine = spawn_entity(
            ...
            [
                RoutineComponent(
                    activity=activity, interval_seconds=24 * HOUR, next_due_epoch=hour * HOUR
                )
            ],
        )
...
def _status(actor, left_id, right_id, status):
    ...
    from bunnyland.simpacks.lifesim.mechanics import RelationshipStatus
...
_RESIDENTS = (
    {
        ...
        "schedule": (
            (9, "chase the north light with a fresh canvas"),
    ...
    },
    {
        ...
        "emoji": "✍️",
        "stage": "adult",
        "career": ("bartending poet", 9),
        "skills": {"poetry": 7, "mixology": 3},
        "funds": 18,
        ...
        "schedule": (
            (11, "nurse coffee and a hangover"),
    ...
    },
    {
        ...
        "emoji": "\U0001f3b7",
        "stage": "adult",
        "career": ("jazz trumpeter", 15),
        "skills": {"trumpet": 8, "composition": 4},
        "funds": 60,
    ...
    },
    {
        ...
        "emoji": "\U0001f33b",
        "stage": "elder",
        "career": ("retired botanist", 0),
        "skills": {"gardening": 9, "herbalism": 5},
        "funds": 320,
        ...
        "schedule": (
            (6, "water the rooftop beds at first light"),
    ...
    },
    {
        ...
        "stage": "adult",
        "career": ("tinkerer", 10),
        "skills": {"engineering": 7, "lockpicking": 4},
        "funds": 45,
        ...
        "schedule": (
            (10, "solder the day's contraption"),
    ...
    },
    {
        ...
        "stage": "adult",
        "career": ("supper-club chef", 13),
        "skills": {"cooking": 8, "baking": 7},
        "funds": 160,
    ...
    },
    {
        ...
        "emoji": "\U0001f4f1",
        "stage": "adult",
        "career": ("content creator", 8),
        "skills": {"dance": 6, "self-promotion": 9},
        "funds": 75,
    ...
    },
    {
        ...
        "emoji": "\U0001f9f0",
        "stage": "adult",
        "career": ("superintendent", 11),
        "skills": {"plumbing": 7, "snooping": 6},
        "funds": 200,
...
async def apartment_example(actor, seed: str, options: GenOptions) -> InstantiatedWorld:
    ...
    proposal = WorldProposal(
        ...
        rooms=[
            # Outdoor approaches.
            RoomSpec(
                key="street", title="Mulberry Street Stoop", biome="city", light=0.8, celsius=14.0
            ),
            RoomSpec(key="alley", title="Side Alley", biome="city", light=0.3, celsius=13.0),
            RoomSpec(key="roof", title="Tar Beach Rooftop", biome="city", light=0.85, celsius=15.0),
            # The vertical spine: lobby, four landings, the elevator car, and below-ground.
            RoomSpec(
                key="lobby",
                title="Lobby & Mailroom",
                biome="building",
                indoor=True,
                light=0.6,
                celsius=20.0,
        ...
        objects=[
            ...
            ObjectSpec(
                key="o_mailboxes",
                room_key="lobby",
                name="a wall of brass mailboxes",
                kind="container",
                portable=False,
            ),
            ObjectSpec(
            ...
            ObjectSpec(
                key="o_moonflower",
                room_key="roof",
                name="a rare night-blooming moonflower",
                kind="item",
                portable=True,
            ),
            ObjectSpec(
                key="o_beds",
                room_key="roof",
                name="rows of raised garden beds",
                kind="item",
                portable=False,
            ),
            # Bruno's kitchen.
            ObjectSpec(
                key="o_croissants",
                room_key="apt_bruno",
                name="a tray of warm croissants",
                kind="food",
                nutrition=5.0,
                satiety=22.0,
                portable=True,
            ...
            ObjectSpec(
                key="o_paints",
                room_key="apt_margot",
                name="a heap of squeezed paint tubes",
                kind="item",
                portable=True,
            ),
            # Lew's garret.
            ...
            ObjectSpec(
                key="o_records",
                room_key="apt_dizzy",
                name="leaning stacks of records",
                kind="item",
                portable=False,
            ),
            # Agnes's perch.
            ObjectSpec(
                key="o_binoculars",
                room_key="apt_agnes",
                name="a worn pair of binoculars",
                kind="item",
                portable=True,
            ),
            ObjectSpec(
            ...
            ObjectSpec(
                key="o_boiler",
                room_key="basement",
                name="the groaning boiler",
                kind="item",
                portable=False,
            ),
            ObjectSpec(
                key="o_lostkeys",
                room_key="subbasement",
                name="a hoard of lost keys",
                kind="item",
                portable=True,
            ),
        ],
        characters=[
            CharacterSpec(
                ...
                traits=("temperamental", "generous"),
            ),
            CharacterSpec(
                key="lew",
                name="Llewyn Ashgrove",
                room_key="apt_lew",
                controller="suspended",
                traits=("melancholic", "charming"),
            ),
            CharacterSpec(
                key="dizzy",
                name="Dizzy Okonkwo",
    ...
    async with actor._lock:
        ...
        business = spawn_entity(
            actor.world, [BusinessOwnerComponent(name="Bruno's Secret Supper", default_price=30)]
        )
        ...
        actor.world.get_entity(rooms["roof"]).add_component(
            EditorDisplayComponent(emoji="\U0001f33f")
        )
        ...
        _note(
            actor,
            rooms["roof"],
            "a letter behind the water tank",
            "An Old Letter",
